    ...
    <Card className="transition-all duration-300 hover:shadow-md w-full">
        ...
        {!isExpanded && (
          <div className="mt-3">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center text-xs text-gray-500 space-y-1 sm:space-y-0 sm:space-x-4 mb-4">
              <span className="font-modern">✓ Experiencia enriquecedora</span>
              <span className="font-modern">✓ Certificado de participación</span>
              <span className="font-modern">✓ Horarios flexibles</span>
            </div>
          </div>
        )}
      ...
      {isExpanded && (
        <CardContent className="space-y-4 animate-in slide-in-from-top-2 duration-300 p-4 sm:p-6 pt-0">
          <div>
            <Label htmlFor="fullname" className="text-sm font-modern">
              Nombre completo *
            </Label>
            <Input
              id="fullname"
            ...
            />
            {errors.fullname && <p className="text-red-500 text-xs mt-1 font-modern">{errors.fullname}</p>}
          </div>

          <div>
            <Label htmlFor="email-volunteer" className="text-sm font-modern">
              Correo electrónico *
            </Label>
            <Input
              id="email-volunteer"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <Label htmlFor="age" className="text-sm font-modern">
                Edad *
              </Label>
              ...
              {errors.age && <p className="text-red-500 text-xs mt-1 font-modern">{errors.age}</p>}
            </div>

            <div>
              <Label htmlFor="cedula" className="text-sm font-modern">
                Número de cédula *
              </Label>
              <Input
                id="cedula"
              ...
              />
              {errors.cedula && <p className="text-red-500 text-xs mt-1 font-modern">{errors.cedula}</p>}
            </div>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <Label htmlFor="country" className="text-sm font-modern">
                País *
              </Label>
              <div className="relative mt-1">
              ...
              {errors.country && <p className="text-red-500 text-xs mt-1 font-modern">{errors.country}</p>}
            </div>

            <div>
              <Label htmlFor="city" className="text-sm font-modern">
                Ciudad/Región *
              </Label>
              <Input
                id="city"
              ...
              />
              {errors.city && <p className="text-red-500 text-xs mt-1 font-modern">{errors.city}</p>}
            </div>
          </div>

          <div>
            <Label htmlFor="phone-volunteer" className="text-sm font-modern">
              Número de teléfono *
            </Label>
            <Input
              id="phone-volunteer"
          ...
          <div>
            <Label htmlFor="experience" className="text-sm font-modern">
          ...
          <div>
            <Label htmlFor="availability" className="text-sm font-modern">
              Disponibilidad
            </Label>
          ...
          <div>
            <Label htmlFor="interests" className="text-sm font-modern">
              Áreas de interés
            </Label>
          ...
          <div>
            <Label htmlFor="observations" className="text-sm font-modern">
              Observaciones
            </Label>
            <Textarea
              id="observations"
          ...
          <div className="bg-blue-50 p-3 sm:p-4 rounded-lg border border-blue-200">
            <div className="flex items-start space-x-2">
              ...
              <label htmlFor="terms" className="text-xs sm:text-sm text-gray-700 font-modern">
          ...
          <div className="flex flex-col sm:flex-row gap-3 pt-2">
            <Button className="w-full sm:flex-1 bg-red-500 hover:bg-red-600 text-sm sm:text-base font-modern">
