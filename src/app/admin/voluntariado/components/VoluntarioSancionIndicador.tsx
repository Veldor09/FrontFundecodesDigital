...
export default function VoluntarioSancionIndicator({ voluntarioId, voluntarioNombre }: Props) {
  const { data: sancionesActivas, loading } = useSancionesActivasVoluntario(voluntarioId);
    ...
    <>
      <div className="flex items-center gap-1">
        ...
        >
          ...
          {sancionesActivas.length} Sanción{sancionesActivas.length > 1 ? "es" : ""}
        </Badge>
      </div>
            ...
            return (
              ...
              >
                <div className="flex justify-between items-start mb-3">
                  <div>
                    <h4 className="font-semibold text-red-900">{sancion.tipo}</h4>
                    <p className="text-red-700 text-sm mt-1">{sancion.motivo}</p>
                  </div>
                ...
                <div className="grid grid-cols-2 gap-4 text-sm text-red-700">
                  ...
                  <div>
                    ...
                    <br />
                    {sancion.fechaVencimiento ? formatFecha(sancion.fechaVencimiento) : "Permanente"}
                  </div>
                </div>
